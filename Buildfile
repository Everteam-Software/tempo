...
VERSION_NUMBER = "6.0.0.33-SNAPSHOT"
...
define "tempo" do
  ...
  define "cas-webapp" do
    libs = SECURITY_WS_CLIENT, AXIOM, AXIS2, CAS_LIBS, 
  ...
  define "dao-tools" do
    compile.with projects("tms-axis", "tms-common", "tms-client", "dao-nutsNbolts"), 
  ...
  define "wds-service" do |project|
    libs = [ projects("dao-nutsNbolts", "tms-client", "tms-axis", "tms-common"), 
      AXIS2, AXIOM, APACHE_COMMONS[:io], APACHE_COMMONS[:httpclient], APACHE_COMMONS[:codec], APACHE_COMMONS[:pool], APACHE_JPA, DOM4J, JAXEN, LOG4J, SERVLET_API, SLF4J, SPRING[:core], STAX_API, WS_COMMONS_SCHEMA, WSDL4J, WOODSTOX, XERCES, XMLBEANS, DEPLOY_API, REGISTRY, SECURITY, WEB_NUTSNBOLTS ]

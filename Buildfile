...
VERSION_NUMBER = "6.0.0.59-SNAPSHOT"
...
>>>>>>> 61ebce3a12bcdc8b774c78c62bdce7a0a077260d:Buildfile
		libs_common= []
...
<<<<<<< HEAD:Buildfile
		package :jar
		package(:aar).with(:services_xml=>_('src/main/axis2/services.xml'),:libs=>libs, :wsdls=>_('src/main/axis2/*.xsd'))
=======

...
VERSION_NUMBER = "5.2.0.25-SNAPSHOT"
NEXT_VERSION = "5.2.0.26"
...
define "tempo" do
  ...
  define "ui-fw-portlet" do
    libs = projects("security", "security-ws-client", "security-ws-common", "tms-axis", "tms-client", "tms-common", "ui-pluto"),

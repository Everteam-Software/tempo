...
AXIS2 = [
  group("axis2-transport-http", "axis2-transport-local", "axis2-kernel", "axis2-adb", "axis2-xmlbeans", "axis2-json", :under=>"org.apache.axis2", :version=>"1.5.4"),
...
SECURITY_WS_CLIENT_ONLY = group("security-api", "security-ws-client", :under=>"org.intalio.security", :version=>"1.0.16")
WEB_NUTSNBOLTS = "org.intalio.security:security-web-nutsNbolts:jar:1.0.16"

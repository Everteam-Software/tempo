...
SECURITY = group("security-api", :under=>"org.intalio.security", :version=>"6.5.03")
SECURITY_WS_COMMON = group("security-ws-common", :under=>"org.intalio.security", :version=>"6.5.03")
SECURITY_WS_CLIENT = group("security-api", "security-ws-client", "security-ws-common", :under=>"org.intalio.security", :version=>"6.5.03")
SECURITY_WS_CLIENT_ONLY = group("security-api", "security-ws-client", :under=>"org.intalio.security", :version=>"6.5.03")
WEB_NUTSNBOLTS = "org.intalio.security:security-web-nutsNbolts:jar:6.5.03"

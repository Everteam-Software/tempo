...
public class JPATaskTest {
  ...
  public void testFetchForUserRolesWithCriteria(String userId, String[] roles, TaskType taskType, TaskState taskState, int size) throws Exception {
    Task[] tasks = new TaskFetcher(em).fetchAvailableTasks(new UserRoles(userId, roles), taskType, taskState);

...
//    }
    ...
    public void testUnmarshalTaskWithCreationDate() throws Exception {
    	OMElement rootElement = TestUtils.loadElementFromResource("/taskWithCreationDate.xml");
    	TaskUnmarshaller unmarshaller = new TaskUnmarshaller();
        PATask task = (PATask)unmarshaller.unmarshalFullTask(rootElement);
        Date creationDate = task.getCreationDate();
        XsdDateTime da = new XsdDateTime("2008-09-25T20:48:29.622+08:00");
        assertEquals(da.getTime(), creationDate);
    }
}

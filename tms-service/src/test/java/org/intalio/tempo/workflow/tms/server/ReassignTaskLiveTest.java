...
public class ReassignTaskLiveTest extends TestCase {
	...
	private static final Logger _logger = LoggerFactory
			.getLogger(ReassignTaskLiveTest.class);

	public static void main(String[] args) {
		junit.textui.TestRunner.run(ReassignTaskLiveTest.class);
	}
	
	private static boolean execute = false;
	static{
		execute = "true".equalsIgnoreCase(System.getProperty("ReassignTaskLive", "false"));
	}
	...
	public void testReassginLive() throws Exception{
		...
		_logger.debug("Get the users: "+arrayToString(users));

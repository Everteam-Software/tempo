...
CREATE TABLE tempo_notification (id NUMBER NOT NULL, failure_code VARCHAR2(255), failure_reason VARCHAR2(255), input_xml CLOB, priority NUMBER, state NUMBER, PRIMARY KEY (id));

...
CREATE TABLE tempo_attachment_meta (id BIGINT NOT NULL, creation_date TIMESTAMP, description VARCHAR(255), file_name VARCHAR(255), mime_type VARCHAR(255), title VARCHAR(255), widget VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE tempo_notification (id BIGINT NOT NULL, failure_code VARCHAR(255), failure_reason VARCHAR(255), input_xml CLOB, priority INTEGER, state SMALLINT, PRIMARY KEY (id));
CREATE TABLE tempo_pa (id BIGINT NOT NULL, complete_soap_action VARCHAR(255), deadline TIMESTAMP, failure_code VARCHAR(255), failure_reason VARCHAR(255), input_xml CLOB, is_chained_before SMALLINT, output_xml CLOB, previous_task_id VARCHAR(255), priority INTEGER, process_id VARCHAR(255), state SMALLINT, PRIMARY KEY (id));
...
CREATE TABLE tempo_task (id BIGINT NOT NULL, creation_date TIMESTAMP, description VARCHAR(255), form_url VARCHAR(255), tid VARCHAR(255), internal_id INTEGER, PRIMARY KEY (id));

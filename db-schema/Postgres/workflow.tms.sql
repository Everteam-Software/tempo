...
CREATE TABLE tempo_task (id BIGINT NOT NULL, creation_date ABSTIME, description VARCHAR(255), form_url VARCHAR(255), tid VARCHAR(255), internal_id INTEGER, PRIMARY KEY (id));

	        ...
	        for (Object task : tasks) {
	            if (task instanceof Notification) {
	                ...
	                if (!TaskState.COMPLETED.equals(notification.getState())) {
	                    ...
	                    jtask.put("taskUrl", notificationURL+"?id="+notification.getID()+"&url="+notification.getFormURLAsString()+"&token="+token+"&user="+userName);
	                ...
	                if (!TaskState.COMPLETED.equals(paTask.getState())) {
	                	JSONObject jtask = new JSONObject();
	                    jtask.put("taskUrl", peopleActivityUrl+"?id="+paTask.getID()+"&url="+paTask.getFormURLAsString()+"&token="+token+"&user="+userName);
	                ...
	                jprocess.put("taskUrl", peopleInitiatedProcessURL+"?id="+pipaTask.getID()+"&url="+pipaTask.getFormURLAsString()+"&token="+token+"&user="+userName);

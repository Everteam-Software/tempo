...
public class DeleteAllTasksActionTest extends TestCase {
    ...
    public void testExecute(){
        ...
        expect.that(new Expectations(){{
            ...
            atLeast(1).of(request).getScheme();will(returnValue("schema"));
            atLeast(1).of(request).getServerName();will(returnValue("MockServer"));
            atLeast(1).of(request).getServerPort();will(returnValue(90));            
        }});
